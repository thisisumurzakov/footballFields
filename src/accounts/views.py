...
class ActivateUserView(APIView):
        ...
        request_body=openapi.Schema(
            ...
            properties={
                "phone_number": openapi.Schema(
                    type=openapi.TYPE_STRING, description="User phone number"
                ),
                "activation_code": openapi.Schema(
                    type=openapi.TYPE_STRING, description="Activation code sent via SMS"
                ),
            },
        ),
        responses={
    ...
    def post(self, request, *args, **kwargs):
        ...
        if activation_data_json:
            ...
            return Response(
                {"error": "Activation data not found or expired."},
                status=status.HTTP_400_BAD_REQUEST,
            )
